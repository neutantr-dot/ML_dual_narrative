...
if inputs_filled:
    if st.button("Generate Poetic Responses"):
        ...
        new_col1 = pd.Series([input1_1, input1_2, input1_3, input1_4, response1], name=f"Session {session_id}")
        new_col2 = pd.Series([input2_1, input2_2, input2_3, input2_4, response2], name=f"Session {session_id}")
